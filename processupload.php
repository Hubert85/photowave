...
if(isset($_POST))
{
    ...
    $DestinationDirectory   = 'D:/wwwdata/school.surwave.ch/uploads/'; //Upload Directory ends with / (slash)
...
//Get file extension from Image name, this will be re-added after random name
    ...
    if(resizeImage($CurWidth,$CurHeight,$BigImageMaxSize,$DestRandImageName,$CreatedImage,$Quality,$ImageType))
    {
        ...
        */
        ...
        mysql_query("INSERT INTO tblfoto (ImageName, ThumbName, ImgPath)
        VALUES ($DestRandImageName, $thumb_DestRandImageName, 'uploads/')");
        
		mysql_query("INSERT INTO tblfoto (FotoName, IP, UserID, FotoPath)
        VALUES ($DestRandImageName, $ip, $_SESSION["userid"], uploads/$NewImageName)");
		*/
		
		$query = "
			INSERT INTO
				tblfoto
				(FotoName, IP, UserID, FotoPath)
			VALUES
				('$NewImageName', '$ip', '$userid', 'uploads/$NewImageName')
		";
